title 'Tests to confirm libxcb library exists'

plan_origin = ENV['HAB_ORIGIN']
plan_name = input('plan_name', value: 'libxcb')

control 'core-plans-libxcb-library-exists' do
  impact 1.0
  title 'Ensure libxcb library exists'
  desc '
  Verify libxcb library by ensuring that 
  ...
  library_filename = input('library_filename', value: 'libxcb.so')
  ...
  pkgconfig_filename = input('pkgconfig_filename', value: 'xcb.pc')
