title 'Tests to confirm postgresql11 habitat service works as expected'

plan_origin = ENV['HAB_ORIGIN']
plan_name = input('plan_name', value: 'postgresql11')

control 'core-plans-postgresql11-habservice-works' do
  impact 1.0
  title 'Ensure postgresql11 habitat service works as expected'
  desc '
  Verify postgresql11 habitat service by ensuring that
