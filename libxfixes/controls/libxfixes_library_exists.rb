title 'Tests to confirm libxfixes library exists'

plan_origin = ENV['HAB_ORIGIN']
plan_name = input('plan_name', value: 'libxfixes')

control 'core-plans-libxfixes-library-exists' do
  impact 1.0
  title 'Ensure libxfixes library exists'
  desc '
  Verify libxfixes library by ensuring that
  ...
  library_filename = input('library_filename', value: 'libXfixes.so')
  ...
  pkgconfig_filename = input('pkgconfig_filename', value: 'xfixes.pc')
