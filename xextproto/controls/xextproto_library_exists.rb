title 'Tests to confirm xextproto library exists'

plan_origin = ENV['HAB_ORIGIN']
plan_name = input('plan_name', value: 'xextproto')

control 'core-plans-xextproto-library-exists' do
  impact 1.0
  title 'Ensure xextproto library exists'
  desc '
  Verify xextproto library by ensuring that
  ...
  library_filename = input('library_filename', value: 'lbxproto.h')
  ...
  pkgconfig_filename = input('pkgconfig_filename', value: 'xextproto.pc')
