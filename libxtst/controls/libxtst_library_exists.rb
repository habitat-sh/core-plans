title 'Tests to confirm libxtst library exists'

plan_origin = ENV['HAB_ORIGIN']
plan_name = input('plan_name', value: 'libxtst')

control 'core-plans-libxtst-library-exists' do
  impact 1.0
  title 'Ensure libxtst library exists'
  desc '
  Verify libxtst library by ensuring that 
  ...
  library_filename = input('library_filename', value: 'libXtst.so')
  ...
  pkgconfig_filename = input('pkgconfig_filename', value: 'xtst.pc')
