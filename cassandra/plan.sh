...
pkg_source="http://apache.40b.nl/cassandra/${pkg_version}/apache-${pkg_name}-${pkg_version}-bin.tar.gz"
...
pkg_exposes=(
  port
  # don't expose "ssl-port", "thrift-port" as they may be non existent depending on config
)
