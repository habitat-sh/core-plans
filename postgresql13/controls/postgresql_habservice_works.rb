title 'Tests to confirm postgresql13 habitat service works as expected'

plan_origin = ENV['HAB_ORIGIN']
plan_name = input('plan_name', value: 'postgresql13')

control 'core-plans-postgresql13-habservice-works' do
  impact 1.0
  title 'Ensure postgresql13 habitat service works as expected'
  desc '
  Verify postgresql13 habitat service by ensuring that
