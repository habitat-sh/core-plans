title 'Tests to confirm corretto issues have been fixed'

plan_origin = ENV['HAB_ORIGIN']
plan_name = input('plan_name', value: 'corretto')

control 'core-plans-corretto-issue-001' do
  impact 1.0
  title 'Ensure patchelf successfully injects correct glibc linux library'
  desc '
  This control verifies that a recent issue https://github.com/chef-base-plans/corretto/issues/1
