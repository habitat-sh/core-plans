title 'Tests to confirm corretto works as expected'

plan_origin = ENV['HAB_ORIGIN']
plan_name = input('plan_name', value: 'corretto')

control 'core-plans-corretto-works' do
  impact 1.0
  title 'Ensure corretto works as expected'
  desc '
  Verify corretto by ensuring that
