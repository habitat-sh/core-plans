...
do_install() {
  source <(perl -I"$(pkg_path_for local-lib)/lib/perl5" -Mlocal::lib="$(pkg_path_for local-lib)")
  source <(perl -I"$(pkg_path_for cpanminus)/lib/perl5" -Mlocal::lib="$(pkg_path_for cpanminus)")
