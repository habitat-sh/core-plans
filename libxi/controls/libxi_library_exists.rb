title 'Tests to confirm libxi library exists'

plan_origin = ENV['HAB_ORIGIN']
plan_name = input('plan_name', value: 'libxi')

control 'core-plans-libxi-library-exists' do
  impact 1.0
  title 'Ensure libxi library exists'
  desc '
  Verify libxi library by ensuring that 
  ...
  library_filename = input('library_filename', value: 'libXi.so')
  ...
  pkgconfig_filename = input('pkgconfig_filename', value: 'xi.pc')
