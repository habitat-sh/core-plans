...
$pkg_bin_dirs=@(
    "Contents\VC\Tools\MSVC\14.27.29110\bin\HostX64\x64",
    "Contents\VC\Redist\MSVC\14.27.29016\x64\Microsoft.VC142.CRT",
    "Contents\MSBuild\Current\Bin\amd64"
)
$pkg_lib_dirs=@(
    "Contents\VC\Tools\MSVC\14.27.29110\atlmfc\lib\x64",
    "Contents\VC\Tools\MSVC\14.27.29110\lib\x64"
)
$pkg_include_dirs=@(
