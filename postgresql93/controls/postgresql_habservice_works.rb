title 'Tests to confirm postgresql93 habitat service works as expected'

plan_origin = ENV['HAB_ORIGIN']
plan_name = input('plan_name', value: 'postgresql93')

control 'core-plans-postgresql93-habservice-works' do
  impact 1.0
  title 'Ensure postgresql93 habitat service works as expected'
  desc '
  Verify postgresql93 habitat service by ensuring that
