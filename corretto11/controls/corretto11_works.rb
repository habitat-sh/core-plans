title 'Tests to confirm corretto11 works as expected'

plan_origin = ENV['HAB_ORIGIN']
plan_name = input('plan_name', value: 'corretto11')

control 'core-plans-corretto11-works' do
  impact 1.0
  title 'Ensure corretto11 works as expected'
  desc '
  Verify corretto11 by ensuring that
